  ...
  return (
    <Container>
      <Header>
        <UserWrapper>
          <UserInfo>
            <Photo source={{ uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Macaca_nigra_self-portrait.jpg/201px-Macaca_nigra_self-portrait.jpg'}}/>
            <User>
              <UserGreeting>Olá,</UserGreeting>
              <UserName>Josias</UserName>
            </User>
          </UserInfo>
